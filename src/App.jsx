...
Return ONLY valid JSON:
{
  ...
  "orderBlocks": [{"type": "bullish|bearish", "high": number, "low": number, "anchor_dt": "string — copy verbatim from the chosen candle's dt field", "tf": "1H|4H", "strength": "strong|moderate|weak", "times_tested": number, "note": "string"}],
  "fvgs": [{"type": "bullish|bearish", "high": number, "low": number, "anchor_dt": "string — dt of the FIRST candle of the 3-candle pattern", "tf": "1H|4H", "filled": boolean, "fill_percentage": number, "overlaps_ob": boolean, "note": "string"}],
  "liquidity": [{"type": "buyside|sellside", "price": number, "anchor_dt": "string — copy verbatim from the chosen candle's dt field", "tf": "1H|4H", "swept": boolean, "note": "string"}],
  "structure": {"type": "bos|choch|none", "direction": "bullish|bearish", "anchor_dt": "string — dt of the break candle", "note": "string"},
